        ...
        <div name='pricing' className='w-full text-white  my-24'>
            ...
            <div className='max-w-[1240px] mx-auto py-12'>
                <div className='text-center py-8 text-slate-300'>
                    ...
                    <p className='text-3xl'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Similique praesentium repellat suscipit, quam rem perferendis. Et, quam doloribus dolore fugit expedita deleniti, error quo minus optio repellat a quos quisquam!</p>
                </div>
